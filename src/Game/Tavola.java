...
public class Tavola {
	...
	public static void tavola() {
		...
		tavolaDaGioco[4][4] = new Tessera(Colore.VERDE);
		...
		tavolaDaGioco[5][2] = new Tessera(Colore.CIANO);
		tavolaDaGioco[5][3] = new Tessera(Colore.VERDE);
		tavolaDaGioco[5][4] = new Tessera(Colore.VERDE);
		tavolaDaGioco[5][5] = new Tessera(Colore.BIANCO);
		tavolaDaGioco[5][6] = new Tessera(Colore.CIANO);
		...
		tavolaDaGioco[7][2] = new Tessera(Colore.CIANO);
		...
		tavolaDaGioco[9][6] = new Tessera(Colore.CIANO);
		tavolaDaGioco[9][7] = new Tessera(Colore.VERDE);
		tavolaDaGioco[9][8] = new Tessera(Colore.CIANO);
	}
