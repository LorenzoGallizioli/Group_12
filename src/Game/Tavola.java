...
public class Tavola extends JPanel{
	...
	public static JPanel[][] tavolaDaGioco = new Tessera[9][9];
	
	public Tavola() {
		super();
		tavolaDaGioco[0][0] = new Tessera(Color.GREEN);
		tavolaDaGioco[0][1] = new Tessera(Color.RED);
		tavolaDaGioco[0][2] = new Tessera(Color.GREEN);
		tavolaDaGioco[0][3] = new Tessera(Color.GREEN);
		tavolaDaGioco[0][4] = new Tessera(Color.GREEN);
		tavolaDaGioco[0][5] = new Tessera(Color.GREEN);
		tavolaDaGioco[0][6] = new Tessera(Color.GREEN);
		tavolaDaGioco[0][7] = new Tessera(Color.GREEN);
		tavolaDaGioco[0][8] = new Tessera(Color.GREEN);
		
		tavolaDaGioco[1][0] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][1] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][2] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][3] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][4] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][5] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][6] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][7] = new Tessera(Color.GREEN);
		tavolaDaGioco[1][8] = new Tessera(Color.GREEN);
		
		tavolaDaGioco[2][0] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][1] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][2] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][3] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][4] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][5] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][6] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][7] = new Tessera(Color.GREEN);
		tavolaDaGioco[2][8] = new Tessera(Color.GREEN);
		...
		tavolaDaGioco[3][1] = new Tessera(Color.GREEN);
		...
		tavolaDaGioco[4][1] = new Tessera(Color.GREEN);
		...
		tavolaDaGioco[5][1] = new Tessera(Color.GREEN);
		...
		tavolaDaGioco[6][1] = new Tessera(Color.GREEN);
		...
		tavolaDaGioco[7][1] = new Tessera(Color.GREEN);
		...
		tavolaDaGioco[8][1] = new Tessera(Color.GREEN);
